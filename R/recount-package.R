...
#' you can download \link[SummarizedExperiment]{RangedSummarizedExperiment}
...
#' \link[SummarizedExperiment]{RangedSummarizedExperiment} objects can be used 
#' by different packages for performing differential expression analysis. Using
#' \url{http://bioconductor.org/packages/derfinder} you can perform
