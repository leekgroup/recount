...
If you use `snaptron_query()` please cite [stingray.cs.jhu.edu:8090/snaptron/docs/](http://stingray.cs.jhu.edu:8090/snaptron/docs/). _Snaptron_ is separate from `r Biocpkg('recount')`. Thank you!
