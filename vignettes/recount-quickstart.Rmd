...
* __As of April 29, 2019 FANTOM-CAT/recount2 annotation quantifications area available via recount2 thanks to the work by Luidy-Imada, Sanchez, et al., bioRxiv, 2019.__
...
Thanks to Luidy-Imada, Sanchez, et al., bioRxiv, 2019 you can now use the `recount` package to access the FANTOM-CAT annotation that was merged with `recount2`. You can use the main `recount2` website or the `recount::download_study()` function by specifying `type = 'rse-fc'`. See their manuscript for further details on how this annotation was derived.
